...
def compute_homography_and_warp(image, vp1, vp2, clip=True, clip_factor=3):
    ...
    inv_final_homography = np.linalg.inv(final_homography)
    
    warped_img = transform.warp(image, inv_final_homography,
...
if __name__ == '__main__':
    ...
    r_img, matrix = rectify_image(image_name, 2, algorithm='independent')
